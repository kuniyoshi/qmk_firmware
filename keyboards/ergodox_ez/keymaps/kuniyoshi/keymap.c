...
[BASE] = LAYOUT_ergodox(
  ...
  KC_MINS,         KC_Q,        KC_W,          KC_E,    KC_R,    KC_T,    KC_NO,
  KC_EQL,          KC_A,        KC_S,          KC_D,    KC_F,    KC_G,
  KC_LSFT,         KC_Z,        KC_X,          KC_C,    KC_V,    KC_B,    KC_NO,
  KC_TAB,          KC_GRAVE,    KC_MINS,       KC_LEFT, KC_RGHT,
                                                                  KC_ESC, KC_NO,
                                                                          LCMD_T(KC_HANJ),
  ...
  KC_UP,        KC_DOWN, KC_LBRC, KC_RBRC, S(KC_MINS),
  KC_NO,   KC_ENT,
  RCMD_T(KC_HAEN),
  KC_RALT, KC_LCTL, KC_SPC
),
